...
Label(root,text="TRANSLATOR",font="comicsans 20 bold",fg="white",bg="purple").pack(side=TOP,fill=X)
f1=Frame(root,bg="MediumPurple3",padx=45,pady=15,relief=RAISED)
f1.pack(side=TOP,pady=10)

Label(f1,text="Select input Language",fg="white",font="arial 14 bold",bg="purple1",pady=5).grid(row=1,column=0,pady=5)
Label(f1,text="Select output Language",fg="white",font="arial 14 bold",bg="purple1",pady=5).grid(row=1,column=2,pady=5)
lang1=StringVar()
lang2=StringVar()
lang1.set("Choose")
lang2.set("Choose")
...
Label(f1,text="Enter Text",font="arial 14 bold",fg="white",bg="purple3").grid(row=3,column=0,padx=8,pady=8,ipadx=10,ipady=10)
Label(f1,text="Output Text",font="arial 14 bold",fg="white",bg="purple3").grid(row=3,column=2,padx=8,pady=8,ipadx=10,ipady=10)
